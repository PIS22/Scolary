...
@Component({
  ...
  templateUrl: './tranche-form.component.html',
  styleUrl: './tranche-form.component.scss'
})
export class TrancheFormComponent  implements OnInit {
  @Input() valueIn!: any;
  dataForm!: FormGroup;
  classes: Classe[] = [];
  types: TypeFrais[] = [];
